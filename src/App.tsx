    ...
    <>
      <main className="app-container">
        <header className="hero">
          <div className="badge">SYNTHWAVE — ONLINE</div>
          <h1>DRIVE</h1>
          <p className="subtitle">Outrun the future.</p>
        ...
        <section className="info-box">
          ...
          <ul className="social-links">
            <li><a href="https://vite.dev/" target="_blank" rel="noreferrer">Vite Engine</a></li>
            <li><a href="https://react.dev/" target="_blank" rel="noreferrer">React Core</a></li>
          </ul>
        </section>
        ...
        <section className="info-box">
          ...
          <ul className="social-links">
            ...
            <li><a href="https://x.com/Microtronic2" target="_blank" rel="noreferrer">X</a></li>
